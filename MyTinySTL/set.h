...
namespace mystl {
	...
	private:
		// 以 rb_tree 作为底层机制
		typedef rb_tree<key_type, value_type, mystl::identity<value_type>,
	...
	public:
		...
		iterator insert(iterator position, const value_type& x) {
			...
			return t_.insert_unique(reinterpret_cast<rep_iterator&>(position), x);
		}
		template <class InputIterator>
	...
	public:
		...
		iterator insert(iterator position, const value_type& x) {
			typedef typename rep_type::iterator rep_iterator;
			return t_.insert_equal(reinterpret_cast<rep_iterator&>(position), x);
		}
		template <class InputIterator>
		void insert(InputIterator first, InputIterator last) {
